...
to create-disloc
  ...
  ask turtles-on patches with [pxcor = -1 and pycor = 1 ] [ die ]
  ask turtles-on patches with [pxcor = -2 and pycor = 2 ] [ die ]
...
to control-temp
  let current-v-avg (sum [abs vx + abs vy] of turtles )/ num-particles\
